...
function initCookieConsent() {
    ...
    btn_setting_close?.addEventListener('click',   (function () {
        block_setting.classList.add("hidden")
        block_first.classList.remove("hidden")
    }));
    btn_setting_apply?.addEventListener('click', (function () {
    ...
    btn_setting_allow_all?.addEventListener('click', () => allowAll());
